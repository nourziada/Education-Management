                            ...
                            <div class="m-portlet__body">
                                <table class="table table-striped- table-bordered table-hover table-checkable"
                                    ...
                                    <tr>
                                        ...
                                        <th>المبادرات الوزارية المرتبطة</th>
                                        <th>مؤشر القياس</th>
                                        <th>المستهدفون</th>
                                        <th>الحالة</th>
                                        <th>الإجراءات</th>
                                    ...
                                    @forelse($projects as $project)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown ">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('strategic.edit',$project->id) }}">
                                            ...
                                            <td>
                                                <a href="{{ route('strategic.show',$project->id) }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="View">
