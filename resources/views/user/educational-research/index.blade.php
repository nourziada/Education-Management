                                ...
                                <table class="table table-striped- table-bordered table-hover table-checkable"
                                    ...
                                    @forelse($projects as $project)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown ">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('educational-research.edit',$project->id) }}">
                                            ...
                                            <td>
                                                <a href="{{ route('educational-research.show',$project->id) }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="View">
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ route('educational-research.destroy',$project->id) }}" method="POST">
                                                            {{ csrf_field() }}
                                                            {{ method_field('DELETE') }}
