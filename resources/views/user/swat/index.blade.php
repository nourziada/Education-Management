                            ...
                            <div class="m-portlet__body">
                                <table class="table table-striped- table-bordered table-hover table-checkable"
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>اسم المستخدم</th>
                                        <th>اسم الخطة التشغيلية المدخلة</th>
                                        <th>الحالة</th>
                                        <th>الإجراءات</th>
                                        <th>التفاصيل</th>
                                    </tr>
                                    ...
                                    @forelse($projects as $project)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ \App\OperationalPlan::find($project->operational_plan_id)->plane_title }}</td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown ">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('swat.edit',$project->id) }}">
                                            ...
                                            <td>
                                                <a href="{{ route('swat.show',$project->id) }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="View">
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ route('swat.destroy',$project->id) }}" method="POST">
                                                            {{ csrf_field() }}
                                                            {{ method_field('DELETE') }}
