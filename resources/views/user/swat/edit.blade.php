                            ...
                            <form class="m-form m-form--fit m-form--label-align-right" action="{{route('swat.update',$data->id)}}" method="POST">
                                ...
                                <div class="m-portlet__body">
                                    ...
                                    <div class="form-group m-form__group">
                                        ...
                                        <textarea class="form-control m-input m-input--square" name="strong" placeholder="أدخل نقاط القوة رجاءً" required>{{ $data->strong }}</textarea>
                                    </div>


                                    <div class="form-group m-form__group">
                                        <label for="week">نقاط الضعف</label>
                                        <textarea class="form-control m-input m-input--square" name="week" placeholder="أدخل نقاط الضعف رجاءً" required>{{ $data->week }}</textarea>
                                    </div>

                                    <div class="form-group m-form__group">
                                        <label for="opportunities">الفرص</label>
                                        <textarea class="form-control m-input m-input--square" name="opportunities" placeholder="أدخل الفرص رجاءً" required>{{ $data->opportunities }}</textarea>
                                    </div>

                                    <div class="form-group m-form__group">
                                        <label for="threats">التهديدات</label>
                                        <textarea class="form-control m-input m-input--square" name="threats" placeholder="أدخل التهديدات رجاءً" required>{{ $data->threats }}</textarea>
                                    </div>
