                                ...
                                <table class="table table-striped- table-bordered table-hover table-checkable"
                                    ...
                                    @forelse($projects as $project)
                                        ...
                                        <tr>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            @if($roles->contains('role_id', 3) || $user->email == 'admin@admin.com')
                                                                @if($project->is_confirmed == 0)
                                                                    <a class="dropdown-item" href="{{ route('admin.swat.accept',$project->id) }}">
                                            ...
                                            <td>
                                                <a href="{{ route('admin.swat.details',$project->id) }}" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="View">
