                        ...
                        <div class="m-portlet m-portlet--full-height ">
                            ...
                            <div class="m-portlet__body">
                                <div class="col-xl-4 order-1 order-xl-2 m--align-left">
                                    <a href="{{ route('initiatives-menus.create') }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill button-add-custom">
												<span>
													<i class="la la-send"></i>
													<span>اضافة مبادرة</span>
												</span>
                                    </a>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown ">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('initiatives-menus.edit',$data->id) }}">
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ route('initiatives-menus.destroy',$data->id) }}" method="POST">
                                                            {{ csrf_field() }}
                                                            {{ method_field('DELETE') }}
