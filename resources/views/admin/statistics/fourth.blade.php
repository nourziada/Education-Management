                            ...
                            <div class="m-portlet__body">
                                ...
                                <table class="table table-striped- table-bordered table-hover table-checkable"
                                    ...
                                    <tr>
                                        ...
                                        <th>الادارة</th>
                                        <th>القسم</th>
                                        <th>عدد إدارة المخاطر المدخلة</th>
                                        ...
                                        @forelse($managments as $manag)
                                            ...
                                            @forelse($departments as $dep)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $risksForms = \App\RiskForm::where('management',$manag->id)->where('department',$dep->id)->get();
                                                            $total = $risksForms->count();
                                                        @endphp
                                        ...
                                        @php $management = \App\Management::find($department->management_id); @endphp
                                            ...
                                            @php $total = 0; @endphp
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $risksForms = \App\RiskForm::where('management',$management->id)->where('department',$department->id)->get();
                                                            $total = $risksForms->count();
                                                        @endphp
                                        ...
                                        @php $count = 1; @endphp
                                            ...
                                            @forelse($departments as $dep)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $risksForms = \App\RiskForm::where('management',$management->id)->where('department',$dep->id)->get();
                                                            $total = $risksForms->count();
                                                        @endphp
